...
export class ReservationService {
 ...
 // Cambia esto en tu servicio:
createReservation(dto: ReservationRequestDto): Observable<Reservation> {
  return this.http.post<Reservation>(`${this.apiUrl}/reservations`, dto);
}
